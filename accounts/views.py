...
def register(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            send_email.send()
            # messages.success(request, "Thank you for registering with us. We have sent you a verification email to you."
            #                           " Please verify it!")
...
def order_detail(request, order_id):
    ...
    for item in order_detail:
        subtotal += float(item.quantity) * item.product_price
    context = {
